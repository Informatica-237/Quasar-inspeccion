            ...
            <div class="q-py-xs">
              ...
              <div class="row q-pa-md q-gutter-lg justify-center">
                <div class="q-gutter-md row items-start">
                  <q-input filled v-model="nuevaInfraccion.fechaHora" color="grey-10">
              ...
              <div class="row q-pa-md q-gutter-lg justify-center">
                ...
                <q-input class="col-md-2" standout="bg-grey-10 text-white" v-model="nuevaInfraccion.clase"
                  label="CLASE" />
                  <q-input class="col-md-2" standout="bg-grey-10 text-white" v-model="nuevaInfraccion.vencimiento" label="VENCIMIENTO">
      <template v-slot:append>
        <q-icon name="event" class="cursor-pointer" color="grey-10">
          <q-popup-proxy cover transition-show="scale" transition-hide="scale">
            <q-date v-model="nuevaInfraccion.vencimiento" mask="YYYY-MM-DD" color="grey-10">
              ...
              <div class="row justify-center">
                <h4>
                  <b>OBSERVACIONES / DESCRIPCION / TESTIGOS / PRUEBA
                    DOCUMENTAL</b>
                </h4>
              </div>
              ...
              <div class="row q-pa-md q-gutter-lg justify-center">
                ...
                <div class="col-md-2">
                  <q-select v-model="nuevaInfraccion.retuvoLicencia" :options="opcionretuvolicencia" type="radio" inline
                    color="grey-10" />
                </div>
                <h6>RETUVO VEHICULO</h6>
                <div class="col-md-2">
                  <q-select v-model="nuevaInfraccion.retuvoVehiculo" :options="opcionretuvovehiculo" type="radio" inline
                    color="grey-10" />
                </div>

                <div class="col-md-2">
                  <q-select v-model="nuevaInfraccion.estado" :options="estados" type="radio" inline color="grey-10" />
                </div>
              </div>
...
export default defineComponent({
  ...
  try {
    ...
    const marca = [
      'AUDI', 'BMW', 'CITROEN', 'CHEVROLET', 'DODGE', 'FIAT', 'FORD',
      'HONDA', 'KAWA', 'M. BENZ', 'MITSUBISHI', 'PEUGEOT', 'REANULT',
      'SCANIA', 'TOYOTA', 'V.W', 'YAHAMA', 'OTRO',
    ];
